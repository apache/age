...
**This README file is for the Apache AGE PostgreSQL 13 release**

- **Apache AGE is currently being developed for the PostgreSQL 11, 12 and 13 releases** and will support all the future releases of PostgreSQL.
