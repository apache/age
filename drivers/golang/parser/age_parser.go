...
func InitEmptyAgeoutContext(p *AgeoutContext) {
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = AgeParserRULE_ageout
}
...
func InitEmptyVertexContext(p *VertexContext) {
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = AgeParserRULE_vertex
}
...
type IPathContext interface {
	...
	// Getter signatures
	AllVertex() []IVertexContext
	Vertex(i int) IVertexContext
