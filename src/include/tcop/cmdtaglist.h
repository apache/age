...
PG_CMDTAG(CMDTAG_ALTER_ELABEL, "ALTER ELABEL", true, true, false)
...
PG_CMDTAG(CMDTAG_ALTER_GRAPH, "ALTER GRAPH", true, true, false)
...
PG_CMDTAG(CMDTAG_ALTER_PROPERTY_INDEX, "ALTER PROPERTY INDEX", true, true, false)
...
PG_CMDTAG(CMDTAG_ALTER_VLABEL,"ALTER VLABEL", true, true, false)
...
PG_CMDTAG(CMDTAG_CREATE_ELABEL, "CREATE ELABEL", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_GRAPH, "CREATE GRAPH", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_PROPERTY_INDEX, "CREATE PROPERTY INDEX", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_VLABEL, "CREATE VLABEL", true, false, false)
PG_CMDTAG(CMDTAG_CYPHER, "CYPHER", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_ELABEL, "DROP ELABEL", true, true, false)
...
PG_CMDTAG(CMDTAG_DROP_GRAPH, "DROP GRAPH", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_PROPERTY_INDEX, "DROP PROPERTY INDEX", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_VLABEL,"DROP VLABEL", true, true, false)
