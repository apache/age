...
static char *pg_graph_version_string;
...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"cypher_allow_unsafe_dml", PGC_USERSET, CLIENT_CONN_STATEMENT,
			gettext_noop("Allows unsafe DML on Cypher."),
			NULL,
			GUC_IS_NAME
		},
		&cypher_allow_unsafe_dml,
		false,
		NULL, NULL, NULL
	},
...
static struct config_string ConfigureNamesString[] =
{
	...
	{
		/* Can't be set in postgresql.conf */
		{"pg_graph_version_string", PGC_INTERNAL, PRESET_OPTIONS,
			gettext_noop("Shows the pg_graph server version."),
			NULL,
			GUC_REPORT | GUC_NOT_IN_SAMPLE | GUC_DISALLOW_IN_FILE
		},
		&pg_graph_version_string,
		PG_GRAPH_VERSION,
		NULL, NULL, NULL
	},
