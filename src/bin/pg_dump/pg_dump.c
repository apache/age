...
/*
 * pg_graph dump methods
 * 
 * The pg_graph generates tables and schemas under the names ELABEL (VLABEL)
...
dumpConstraint(Archive *fout, ConstraintInfo *coninfo)
{
		...
		coninfo->contype == 'x')
	{
		...
		/*
		 * This is special case on pg_graph constraint. There should be
